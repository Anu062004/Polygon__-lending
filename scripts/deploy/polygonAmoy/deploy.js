...
async function main() {
    console.log("🚀 Starting Debpol Protocol deployment to Polygon Amoy...");
    ...
    if (balance < ethers.parseEther("0.1")) {
        console.log("⚠️  Warning: Low balance. Consider getting testnet MATIC from faucet.");
    }
    ...
    try {
        ...
        const frontendConfigPath = path.join(__dirname, "../../deploy-config/polygonAmoy.json");
